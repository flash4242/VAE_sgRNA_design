...
class Config():
    def __init__(self):
        ...
        self.batch_size = 256
        self.epochs = 500
        self.train_split = 0.7 # 0.7
        self.validation_split = 0.15 # 0.15
...
best_model_path = "without_dropout/best_wd_model.pth"
...
metrics_df.to_csv("without_dropout/ont_wd_model_training_metrics.csv", index=False)
#print("Metrics saved to ont_hl60/ont_hl60_model_training_metrics.csv")
...
plt.grid(True)
plt.savefig("without_dropout/wd_regplot.png")
# ----------------------- REGPLOT - END --------------------------------
